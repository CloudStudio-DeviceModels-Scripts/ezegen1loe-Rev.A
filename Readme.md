...
# Parsing Script – ezegen1loe - Rev. A

This **Parsing** script is designed for the **ezegen1loe** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – ezegen1loe Rev. A

Este script de **Parsing** está diseñado para el modelo **ezegen1loe** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
